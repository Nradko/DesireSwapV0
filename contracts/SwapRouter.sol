...
contract SwapRouter is ISwapRouter, PeripheryImmutableState, PeripheryValidation, PeripheryPayments, Multicall {
  ...
  function exactInputInternal(
    ...
    (int256 amount0, int256 amount1) = getPool(tokenIn, tokenOut, fee).swap(recipient, zeroForOne, int256(amountIn),0, abi.encode(data));
  ...
  function exactOutputInternal(
    ...
    (int256 amount0Delta, int256 amount1Delta) = getPool(tokenIn, tokenOut, fee).swap(recipient, zeroForOne, -int256(amountOut),0, abi.encode(data));
