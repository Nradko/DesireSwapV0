...
// 			= IDesireSwapV0Pool(poolAddress).getRangeInfo(index);
...
//     function token0Supply(address poolAddress, uint256 amount0, uint256 sqrtBottom, uint256 sqrtTop)
//     public view
...
//      function token1Supply(address poolAddress, uint256 amount1, int24 lowestIndex, int24 highestIndex)
//     public view
//     returns(uint256, uint256)
//     {
//         uint256 currentPrice = currentPrice(poolAddress);
