...
contract Quoter is IDesireSwapV0SwapCallback, PeripheryImmutableState {
  ...
  function desireSwapV0SwapCallback(
        ...
        (address tokenIn, address tokenOut, uint256 fee) = path.decodeFirstPool();
    ...
    function quoteExactOutput(bytes memory path, uint256 amountOut) external   returns (uint256 amountIn) {
        while (true) {
            ...
            (address tokenOut, address tokenIn, uint256 fee) = path.decodeFirstPool();
