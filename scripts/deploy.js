...
async function main() {
  try {
    ...
    console.log('liq helper address: %s', tHelper.address);
    ...
    await tokenA.connect(owner).transfer('0xb9B5e3ae85a40DB0ad4f78d08f63a7d9c2c4e6b8', '100000000000000000000000');
    await tokenB.connect(owner).transfer('0xb9B5e3ae85a40DB0ad4f78d08f63a7d9c2c4e6b8', '100000000000000000000000');
